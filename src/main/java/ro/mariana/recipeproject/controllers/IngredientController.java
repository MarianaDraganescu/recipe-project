...
public class IngredientController {
    ...
    @GetMapping("/recipes/{recipeId}/ingredient/{id}/show")
    ...
    @GetMapping("recipes/{recipeId}/ingredient/new")
    ...
    @GetMapping("/recipes/{recipeId}/ingredient/{id}/update")
    ...
    @GetMapping("recipes/{recipeId}/ingredient/{id}/delete")
